...
const Welcome: React.FC = () => {
    ...
    const [animateExit, setAnimateExit] = useState(false); // For controlling exit animation
    const totalPages = 3;
    ...
    const handlePageChange = (page: number) => {
        if (page > totalPages) {
            ...
            setTimeout(() => navigate('/loader'), 500); // Navigate after animation
                ...
                >
                    ...
                    >
                        ...
                        <div className="pages flex flex-col justify-center items-center text-center min-w-full h-full">
                            <div
                                id="page1"
                                className="relative w-full h-[65%] flex justify-center items-center -mt-32 bg-center"
                                style={{ backgroundImage: `url(${Background1})` }}
                            >
                                <img
                                    src={DotsTop}
                                    alt="Decorative dots"
                                    className="absolute top-[15%] left-1/2 transform -translate-x-1/2 z-20 max-w-full h-auto"
                                />
                                <img
                                    src={Hands}
                                    alt="Hands"
                                    className="absolute bottom-[20%] left-1/2 transform -translate-x-1/2 z-20 max-w-full h-auto"
                                />
                                <img
                                    src={HomeAICompanion}
                                    alt="AI Companion"
                            ...
                            <h1 className="text-white font-bold mb-0 max-w-[896px]">
                            ...
                            <p className="text-gray-400 font-medium max-w-[968px]">
                                Meet F.R.I.D.A.Y.—your always-available AI assistant. Chat through text or interact with
                                a dynamic avatar, getting real-time, human-like responses. It's not just a chatbot; it’s
                                an intelligent companion that’s ready to make your life easier, one conversation at a
                                time.
                            </p>
                        </div>
                        ...
                        <div className="pages flex flex-col justify-center items-center text-center min-w-full h-full">
                            ...
                            <h2 className="text-gray-400 font-semibold mb-5">
                                Smarter Assistance, Secured with Advanced Privacy
                            </h2>
                            <p className="text-gray-400 font-medium max-w-[968px]">
                                F.R.I.D.A.Y. learns from your preferences to deliver personalized, smarter assistance every time.
                                Your data and privacy are our top priorities, with advanced encryption ensuring your
                                information is always safe. Experience AI that knows you, while keeping your data fully protected.
                            </p>
                        </div>
                        ...
                        <div className="pages flex flex-col justify-center items-center text-center min-w-full h-full">
                            ...
                            <p className="text-gray-400 font-medium max-w-[968px]">
                                F.R.I.D.A.Y.'s advanced voice capabilities allow you to talk naturally and get instant, human-like responses.
                                Paired with a lifelike avatar, it delivers an engaging experience that feels less like technology and
                                more like a real conversation. Just speak, and F.R.I.D.A.Y. is ready to assist.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="absolute bottom-[60px] w-full flex justify-center items-center">
                        {[...Array(totalPages)].map((_, index) => (
                            <span
                                key={index}
                                className={`w-[12px] h-[12px] mx-2 rounded-full transition-colors duration-300 cursor-pointer ${
