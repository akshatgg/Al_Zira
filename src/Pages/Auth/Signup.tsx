  ...
  >
    ...
    <div className="flex">
      <div className="text-white flex-1 pl-20 pt-20 mt-20">
        <h1 className="lg:text-7xl md:text-6xl font-sans font-semibold mb-4">Roll the Carpet .!</h1>
      ...
      <div className='flex-0 lg:pr-10 md:pr-5'>
        <div className="text-white border border-white bg-transparent backdrop-filter backdrop-blur-md lg:p-10 md:p-6 rounded-2xl shadow-lg">
          <h2 className="lg:text-3xl md:text-2xl font-sans font-semibold mb-1 mt-4">Signup</h2>
          ...
          <form onSubmit={handleEmail} className='mb-4'>
            ...
            <div className="text-center">
              <button 
                type="submit"
                disabled={loading}
                className={`mb-2 bg-gradient-to-r from-[#2E4DEF] to-[#0E148E] rounded-lg text-white lg:py-[2%] md:py-[1%] w-full cursor-pointer text-lg font-light transition duration-300 hover:from-[#1A2B7D] hover:to-[#0B0E5D] ${
